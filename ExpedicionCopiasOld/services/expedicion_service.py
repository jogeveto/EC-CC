...
from core.pdf_processor import PDFMerger
from core.file_organizer import FileOrganizer
from core.rules_engine import ExcepcionesValidator
from core.time_validator import TimeValidator
from core.auth import Dynamics365Authenticator, AzureAuthenticator
...
class ExpedicionService:
    ...
    def __init__(self, config: Dict[str, Any], logger: Any) -> None:
        """
        Inicializa el servicio con configuración y logger.
